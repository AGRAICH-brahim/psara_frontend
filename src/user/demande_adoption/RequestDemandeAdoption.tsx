...
import DemandeAdoption from "../../components/demande_adoption/DemandeAdoption.tsx";

const  RequestDemandeAdoption = () => {
    return (
        <>
            ...
            <div className="flex flex-col min-h-screen">
                ...
                <div className="flex flex-row h-full flex-1 mt-[70px]">
                    ...
                    {/* Main Content */}
                    <div className="flex flex-col w-3/6 ml-[20%] border w-full min-h-[calc(100vh-64px)] pt-10 bg-gray-100 px-20">
                        <DemandeAdoption/>
                    </div>
...
export default RequestDemandeAdoption;